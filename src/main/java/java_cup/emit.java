...
/**
 * This class handles emitting generated code for the resulting parser_.
 ...
 *          that were embedded in the parser_ specification.
 *   <dt> parser_ class
 *   <dd>   the specialized parser_ class consisting primarily of some user
 *          supplied general and initialization code, and the parse tables.
 *   </dl><p>
 *
 *  Three parse tables are created as part of the parser_ class:
 *    <dl>
 *    <dt> production table
...
/* Major externally callable routines here include:
     ...
     parser_                - emit the parser_ class
   ...
   parser_class_name       - name of the class for the resulting parser_.
   ...
   parser_code             - user supplied declarations and other code to be
			     placed in parser_ class.
   init_code               - user supplied code to be executed as the parser_
...
public class emit {
  ...
  /** Name of the generated parser_ class. */
  public static String parser_class_name = "parser_";
  ...
  /** User declarations for direct inclusion in parser_ class. */
  public static String parser_code = null;

  /*. . . . . . . . . . . . . . . . . . . . . . . . . . . . . .*/

  /** User code for user_init() which is called during parser_ initialization. */
  ...
  /** Do we produce calls debug_gammar in generated parser_? */
  ...
  public static void symbols(PrintStream out, boolean emit_non_terms)
      ...
      for (Enumeration e = terminal.all(); e.hasMoreElements(); )
	{
      ...
      /* do the non terminals if they want them (parser_ doesn't need them) */
      if (emit_non_terms)
	{
          out.println("\n  /* non terminals */");
  ...
  protected static void emit_action_code(PrintStream out, production start_prod)
      ...
      if (action_code != null)
	{
      ...
      out.println("    java_cup.runtime.lr_parser " + pre("parser_,"));
      ...
      for (Enumeration p = production.all(); p.hasMoreElements(); )
	{
	  ...
	  if (prod == start_prod)
	    {
	      out.println("          /* ACCEPT */");
	      out.println("          " + pre("parser_") + ".done_parsing();");
	    }
  ...
  /** Emit the parser_ subclass with embedded tables.
   * @param out             stream to produce output on.
  ...
  public static void parser(
	...
	out.println("import " + import_list.elementAt(i) + ";");
      ...
      out.println("    java_cup.runtime.lr_parser parser_,");
      ...
      out.println("    return action_obj." + pre("do_action(") +
                  "act_num, parser_, stack, top);");
      out.println("  }");
      out.println("");


      /* method to tell the parser_ about the start state */
