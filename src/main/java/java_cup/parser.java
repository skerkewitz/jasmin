...
public class parser extends java_cup.runtime.lr_parser {
   ...
   */
  public java_cup.runtime.token scan() throws IOException {
...
class CUP$actions {
  ...
  protected void add_rhs_part(production_part part) {
    if (rhs_pos >= MAX_RHS) {
      throw new RuntimeException("Internal Error: Productions limited to " + MAX_RHS + " symbols and actions");
    }
  ...
  public final java_cup.runtime.symbol CUP$do_action(
          ...
          int CUP$top) throws internal_error {
