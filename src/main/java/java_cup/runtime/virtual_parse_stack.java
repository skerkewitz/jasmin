...
public class virtual_parse_stack {
  ...
  public virtual_parse_stack(Stack shadowing_stack) {
    ...
    if (shadowing_stack == null)
      throw new RuntimeException("Internal parser_ error: attempt to create null virtual stack");
  ...
  public int top() {
    if (vstack.empty()) {
      throw new RuntimeException("Internal parser_ error: top() called on empty virtual stack");
    }

    return (Integer) vstack.peek();
  }
  ...
  public void pop() {
    if (vstack.empty()) {
      throw new RuntimeException("Internal parser_ error: pop from empty virtual stack");
    }
